...
@section('content')
    ...
    <style>
        body {
            ...
            color: #fff;
            background-image: linear-gradient(rgba(0,0,0,0.9), rgba(0,0,0,0.95)), url('https://images.hdqwalls.com/download/dragon-ball-super-ultra-instinct-goku-4k-2k-1920x1080.jpg');
    ...
    <form action="{{ route('training.complete', $training->id) }}" method="POST">
        ...
        <div class="finish-area">
            ...
            <div class="d-flex justify-content-center">
                <a href="{{ route('dashboard') }}" class="btn btn-outline-light btn-lg px-5 shadow-lg" style="border-radius: 50px;">
